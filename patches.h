...
/*
 * ignore xft errors when drawing text patch 🌟 ------------------------- {{{2
...
/*
 * attach above, side, below, or bottom ❌ ------------------------------ {{{2
...
/*
 * do not die on color allocation failure patch 🌟 ---------------------- {{{2
...
/*
 * NO_TRANSPARENT_BORDERS_PATCH 🌟 -------------------------------------- {{{2
...
/*
 * Bottomstack layout. ❌ ----------------------------------------------- {{{2
 * https://dwm.suckless.org/patches/bottomstack/
 */
#define BSTACK_LAYOUT 0

/*
 * Bottomstack horizontal layout. ❌ ------------------------------------ {{{2
 * https://dwm.suckless.org/patches/bottomstack/
 */
#define BSTACKHORIZ_LAYOUT 0

/*
 * Centered master layout. ❌ ------------------------------------------- {{{2
 * https://dwm.suckless.org/patches/centeredmaster/
 */
#define CENTEREDMASTER_LAYOUT 0

/*
 * Centered floating master layout. ❌ ---------------------------------- {{{2
 * https://dwm.suckless.org/patches/centeredmaster/
 */
...
/*
 * Fibonacci dwindle layout. ❌ ----------------------------------------- {{{2
 * https://dwm.suckless.org/patches/fibonacci/
 */
#define FIBONACCI_DWINDLE_LAYOUT 0

/*
 * Fibonacci spiral layout. ❌ ------------------------------------------ {{{2
 * https://dwm.suckless.org/patches/fibonacci/
 */
#define FIBONACCI_SPIRAL_LAYOUT 0

/*
 * Flextile deluxe layout. 🌟 ------------------------------------------- {{{2
...
/*
 * Gappless grid layout. ❌ --------------------------------------------- {{{2
 * https://dwm.suckless.org/patches/gaplessgrid/
 */
#define GAPPLESSGRID_LAYOUT 0

/*
 * Gridmode (grid) layout. ❌ ------------------------------------------- {{{2
 * https://dwm.suckless.org/patches/gridmode/
 */
#define GRIDMODE_LAYOUT 0

/*
 * Horizontal grid (horizgrid) layout. ❌ ------------------------------- {{{2
 * https://dwm.suckless.org/patches/horizgrid/
 */
#define HORIZGRID_LAYOUT 0

/*
 * Grid layout where nmaster controls the number of rows. ❌ ------------ {{{2
 * https://dwm.suckless.org/patches/nrowgrid/
 */
#define NROWGRID_LAYOUT 0

/*
 * The default tile layout. 🌟 ------------------------------------------ {{{2
 * This can be optionally disabled in favour of other layouts.
 */
#define TILE_LAYOUT 1

/*
 * Monocle layout (default). 🌟 ----------------------------------------- {{{2
 * This can be optionally disabled in favour of other layouts.
 */
